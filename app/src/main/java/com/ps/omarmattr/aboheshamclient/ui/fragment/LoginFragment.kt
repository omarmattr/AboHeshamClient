...
import com.ps.omarmattr.aboheshamclient.ui.viewmodel.LoginViewModel
        ...
        when {
            ...
            phone.editText!!.text.length < 10 -> {
                ...
                val user =  User(
                    ...
                    phone = phone.editText!!.text.toString(),id =  FirebaseFirestore.getInstance().collection(
                        COLLECTION_USER
                    ).document().id)
                ...
                viewModel.getLoginLiveData.observe(viewLifecycleOwner){
                    when (it.status) {
                        ...
                        Result.Status.SUCCESS -> {
                            ...
                            val shared = requireActivity().getSharedPreferences(getString(R.string.app_name_en),
